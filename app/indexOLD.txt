      ...
      <SafeAreaView className="flex-1 bg-white">
          <FlatList
              ...
              <View className={"items-center flex-row justify-between mt-4"}>
                  <View>
                      <Text className="font-bold text-orange-500">DELIVER TO</Text>
...
<View className={bg-orange-500 flex flex-row items-center} style={{backgroundColor:${item.color}}}>
    <View>
        <Text>{item.title}</Text>
        <Image source={images.arrowRight} resizeMode={"cover"} />
    </View>
    <View className={" relative border-2 border-white"}>
        <Image className={""} source={item.image} resizeMode={"contain"} width={30} height={30} />
    </View>
</View>
*/
